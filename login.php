 ...
 <div class="container" style="width:30%;margin-top:100px">
  <div class="card card-container">
   <div style="text-align:center">
    <img id="profile-img" class="profile-img-card" src="upload/avata/avatar_user.png" />
   </div>
   <p id="profile-name" class="profile-name-card"></p>
   <form class="form-signin" action="index.php?act=login" method="post">
    <span id="reauth-email" class="reauth-email"></span>
    <input type="text" name="username" class="form-control" placeholder="Username" autofocus style="margin-bottom:5px">
    <input type="password" name="password" class="form-control" placeholder="Password">
    <div id="remember" class="checkbox">
    </div>
    <input class="btn btn-lg btn-primary btn-block btn-signin" type="submit" name="login1" value="LOGIN">
   </form><!-- /form -->
  </div><!-- /card-container -->
 </div><!-- /container -->
</body>
