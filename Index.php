...
<body>
  ...
  <div class="container-fluid">
   ...
   <form class="form-horizontal">
    <div class="form-group">
     ...
     <div class="col-xs-4">
      <input type="text" id="from" placeholder="Xuất phát" class="form-control" />
     </div>
    </div>
    <div class="form-group">
     <label for="to" class="col-xs-2 control-label"><i class="fas fa-map-marker-alt"></i></label>
     <div class="col-xs-4">
      <input type="text" id="to" placeholder="Đích" class="form-control" />
     </div>
    </div>
   </form>
 ...
 <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA7RR9q56mFM_0PJTKOR5m2yZD8aIltnEE&libraries=places">
 </script>
